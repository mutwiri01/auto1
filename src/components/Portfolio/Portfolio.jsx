    ...
    <div className="portfolio" id="portfolio">
      ...
      >
        <SwiperSlide>
          ...
          <h2>
            Our certified technicians specialize in engine overhauls, breathing
            new life into your vehicle's heart.
          </h2>
        </SwiperSlide>
        <SwiperSlide>
          <img src={g1} alt="" />
          ...
          <h2>
            Our gearbox repair experts are equipped to diagnose and fix any
            transmission issues, whether it's a manual or automatic gearbox
          </h2>
        </SwiperSlide>
        <SwiperSlide>
          <img src={p1} alt="" />
